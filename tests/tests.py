...
def test_pathfinding(db_conn):
    ...
    assert [(node3,edge3_1),(node1,edge1_4),(node4,edge4_5),(node5,None)] != result_expect4
    # The test above is not equal as python doesn't compare equality of contents of each item
    # but rather if they are referencing the same object 
